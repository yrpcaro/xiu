...
def render_helix(pill, b):
    ...
    lines = [
        ...
        '"ui.cursorline.primary" = { bg = "%s" }' % p["surface_container_low"],
        '"ui.linenr" = { fg = "%s" }' % p["faint"],
        '"ui.linenr.selected" = { fg = "%s" }' % p["subtle"],
        '"ui.statusline" = { fg = "%s", bg = "%s" }' % (p["cream"], p["surface_container"]),
        ...
        '"ui.bufferline.active" = { fg = "%s", bg = "%s", modifiers = ["bold"] }' % (p["cream"], p["surface_container"]),
        '"ui.bufferline.background" = {}',
        '"ui.popup" = { bg = "%s" }' % p["surface_container"],
        '"ui.popup.info" = { bg = "%s" }' % p["surface_container_high"],
        '"ui.window" = { fg = "%s" }' % p["surface_container_high"],
        ...
        '"ui.virtual.ruler" = { bg = "%s" }' % p["surface_container_low"],
        # Syntax scopes

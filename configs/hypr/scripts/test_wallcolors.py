...
def main():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        try:
            ...
            assert '"ui.gutter" = {}' in h_text, "helix gutter is transparent"
            assert '"ui.cursorline" = {}' in h_text, "helix cursorline has no background"
            assert '"ui.statusline" = { fg =' in h_text and 'bg =' not in h_text.split('"ui.statusline" = ')[1].splitlines()[0], "helix active statusline is transparent"
            ...
            assert '"ui.bufferline.active" =' in h_text and 'underline =' in h_text.split('"ui.bufferline.active" = ')[1].splitlines()[0], "helix active buffer is transparent with underline"
            assert '"ui.virtual.ruler" = {}' in h_text, "helix ruler has no solid background"
            assert '"ui.virtual.indent-guide" =' in h_text, "helix indent guide is defined"
